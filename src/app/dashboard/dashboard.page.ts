    ...
    private firestore: AngularFirestore
      ...
      this.firebaseService.read_current_badge().subscribe(data => {
        ...
        for(let i = 0; i < this.badgeList.length; i++){
          if(this.badgeList[i].id === "ab77defe-3508-4715-845c-8cb40eb0fb3f"){
        ...
        let id = obj => obj.id === "ab77defe-3508-4715-845c-8cb40eb0fb3f";
      ...
      this.firebaseService.read_user().subscribe(data => {
        ...
        for(let i = 0; i < this.userInfo.length; i++){
          if(this.userInfo[i].id === "ab77defe-3508-4715-845c-8cb40eb0fb3f"){
